...
option_list <- list(
    ...
    make_option("--seeds_file", help = "The dmps tsv file, with row names the DMPs."),
    make_option("--min_seeds", default = 1, type = "integer", help = "The minimum supporting DMPs per DMR, defaults to 1"),
    make_option("--min_adj_seeds", default = 1, type = "integer", help = "The minimum supporting DMPs per DMR, after adjusted by underlying CpG content, defaults to 1"),
