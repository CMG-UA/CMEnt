...
option_list <- list(
  ...
  make_option("--expansion_step", default=5, type="integer", help="The DMR expansion step, affects speed/IO trade-off, defaults to 10 cpg sites."),
  make_option("--beta_row_names_file", default=NULL),
  make_option("--dmps_beta_file", default=NULL),
  ...
  make_option("--output_dir", default=".", help="Output directory for results"),
  make_option("--sample_group_col", default=NULL, help="Sample group column in samplesheet"),
  ...
  make_option(c("--verbose"), action="store_true", default=FALSE, help="Enable verbose output"),
