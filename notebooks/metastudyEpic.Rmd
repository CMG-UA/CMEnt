...
available beta matrix to assemble and score coherent DMRs around those known
...
```
```{r}
cment_fields <- c("n_sites", "n_seeds", "score", "cv_accuracy", "mean_delta_beta", "median_delta_beta", "pval")
...
cat("Top CMEnt DMR based on score:\n")
CMEnt::plotDMRs(
    dmrs_cment,
    top_n = 1,
    score_by = "score",
