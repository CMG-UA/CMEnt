...
```{r}
sim_beta_path <- get_benchmark_file("sim_beta_1000.tsv")
sim_truth_path <- get_benchmark_file("sim_dmrs_1000.tsv")
if (!file.exists(sim_beta_path)) {
    curl::curl_download(
        url = "https://zenodo.org/records/19663986/files/microarray_sim_beta_1000.tsv?download=1",
        destfile = sim_beta_path
    )
}
if (!file.exists(sim_truth_path)) {
    curl::curl_download(
        url = "https://zenodo.org/records/19663986/files/microarray_sim_dmrs_1000.tsv?download=1",
