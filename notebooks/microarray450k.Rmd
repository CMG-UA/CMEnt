...
signals, immune and differentiation pathways, and candidate prognostic genes.
...
dmr_direction <- ifelse(dmr_delta > 0, "Hyper", "Hypo")
...
```{r aml_gene_plot, fig.width=8, fig.height=4}
...
```{r focused_terms_plot, fig.width=10, fig.height=5}
if (nrow(focused_terms) > 0L) {
