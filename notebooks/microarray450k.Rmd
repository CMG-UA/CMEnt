...
ggplot(dmr_effect_df, aes(x = Delta_beta, y = Width, color = Direction)) +
    geom_hline(yintercept = median(dmr_effect_df$Width), linewidth = 0.2, color = "grey70") +
    geom_vline(xintercept = 0, linewidth = 0.2, color = "grey70") +
    geom_point(alpha = 0.55, size = 1.2) +
    facet_wrap(~Region, nrow = 1) +
    scale_y_log10(labels = scales::comma) +
    scale_color_manual(values = c("Hypermethylated in AML" = "#B8405E", "Hypomethylated in AML" = "#247BA0")) +
    theme_minimal() +
    labs(
