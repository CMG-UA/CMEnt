...
test_that("buildDMRs does not bridge across chromosome boundaries", {
...
test_that("buildDMRs Stage 2 expansion matches between sequential and chunked parallel execution", {
    ...
    dmrs_seq <- do.call(buildDMRs, c(args, list(njobs = 1)))
    dmrs_par <- do.call(buildDMRs, c(args, list(njobs = 2)))
