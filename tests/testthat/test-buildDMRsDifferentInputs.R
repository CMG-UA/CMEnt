...
test_that("buildDMRs validates input parameters correctly", {
...
test_that("buildDMRs works with small beta file (in-memory loading)", {
    # Run buildDMRs with beta_in_mem_threshold_mb=500 (small file loaded in memory)
...
test_that("buildDMRs works with BSseq input", {
    set.seed(42)
    n_loci <- 200
    n_cases <- 5
    n_controls <- 5
...
test_that("buildDMRs works when tabix is not available", {
