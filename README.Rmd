...
You can install the development version of CMEnt from GitHub. Currently the repository is private,
so you need to use the organization read-only access authentication key:
```{r eval=FALSE}
