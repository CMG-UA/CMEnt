...
### `njobs`
**Type:** Integer  
**Default:** `getOption("CMEnt.njobs", min(8, future::availableCores() - 1))`  
...
### `chunk_size`
**Type:** Integer
**Default:** `getOption("CMEnt.chunk_size", 1000)`
...
- Random seed is controlled with `options(CMEnt.random_seed = 42)`
...
### Option: `CMEnt.chunk_size`
**Type:** Integer  
**Default:** `1000`  
**Description:** Number of CpGs to process in each chunk. Adjusting this can help manage memory usage and computation time.

```{r}
options("CMEnt.chunk_size" = 10000)
```

## Caching

### Option: `CMEnt.use_bed_cache`
**Type:** Logical  
**Default:** `FALSE`  
...
```{r}
options("CMEnt.use_bed_cache" = TRUE)
```

### Option: `CMEnt.bed_cache_dir`
**Type:** Character  
**Default:** `USER_CACHE_DIR/R/CMEnt/tabix_cache`  
**Description:** Directory for BED file cache.

```{r}
options("CMEnt.bed_cache_dir" = "/path/to/cache")
```

### Option: `CMEnt.use_tabix_cache`
**Type:** Logical  
**Default:** `FALSE`  
...
```{r}
options("CMEnt.use_tabix_cache" = TRUE)
```

### Option: `CMEnt.tabix_cache_dir`
**Type:** Character  
**Default:** `USER_CACHE_DIR/R/CMEnt/tabix_cache`  
**Description:** Directory for tabix file cache.

```{r}
options("CMEnt.tabix_cache_dir" = "/path/to/cache")
```
