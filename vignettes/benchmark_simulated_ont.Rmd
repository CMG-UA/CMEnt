...
if (!file.exists(cment_file)) {
    ...
    options("CMEnt.parallel_backend" = "multicore")
    options("CMEnt.parallel_batch_beta_subset" = "auto")
    options("CMEnt.stage2_hdf5_beta_subset" = "auto")
    options("CMEnt.stage2_materialize_beta_subset" = TRUE)
    options("CMEnt.stage2_materialize_max_memory_mb" = 2048)
    options("CMEnt.stage2_memory_max_chunk_memory_mb" = 2048)
    options("CMEnt.stage2_hdf5_max_chunk_memory_mb" = 256)
    options("CMEnt.stage2_hdf5_parallel_backend" = "multicore")
    options("CMEnt.stage2_hdf5_restart_workers_each_batch" = FALSE)
    start_time <- Sys.time()
