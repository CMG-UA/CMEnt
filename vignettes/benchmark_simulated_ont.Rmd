...
max_bridge_extension_gaps <- 3L # Increase default gap bridging for NGS data to improve sensitivity.
max_lookup_dist <- 100000 # Use a larger lookup distance (10k is the default)
min_seeds <- 2L
min_cpgs <- 2L # Reduce minimum CpGs per DMR to 2 for simulated data, which may have DMRs with few CpGs.
```
...
- Truth_DMRs_With_Enough_Seeds_Pct: Percentage of ground-truth DMRs that have enough overlapping seed CpGs to be captured by DMRsegal.
