...
min_seeds <- 2L
min_cpgs <- 3L
max_pval <- 0.1 # Due too smaller sample size and effect sizes, we relax the p-value threshold.
max_bridge_seeds_gaps <- 1L
max_bridge_extension_gaps <- 2L
max_lookup_dist <- 100000L # Use a larger lookup distance (10k is the default)
```
